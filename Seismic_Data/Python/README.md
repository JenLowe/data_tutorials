...
| [Tide gauges tutorial with Python](Python/GeoNet_Tide_Gauge_Data.ipynb) |Examples of how to be access the data recorded by GeoNet network of water level sensors in Python programming language.|<img src="Python/tide.png">